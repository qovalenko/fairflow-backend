...
/**
 * Background relay loop (E3-01; mirrors the contact reference impl): polls the
 * Mongo outbox for `pending` rows and publishes them to RabbitMQ at-least-once.
 * Self-healing — broker/Mongo hiccups just leave rows `pending` for the next tick.
 *
