 ...
 */
const PURGE_COLLECTIONS = ['companies', 'company_archives'] as const;
 ...
 * of the company domain (live companies + archive snapshots) on a project
 * hard-purge.
 *
...
export class ProjectPurgeConsumer implements OnModuleInit {
  ...
  async onModuleInit(): Promise<void> {
    ...
    const queue = busQueueName('company.project-purge');
    try {
