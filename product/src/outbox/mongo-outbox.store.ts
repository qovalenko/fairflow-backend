...
/**
 * Mongo-backed transactional outbox store (E3-01, RFC-4 §Р-4) for the product domain.
 *
 ...
 * the event row commit or roll back together (invariant Д-1 — "no product without
 * an event, no event without a product"). The relay half reads pending rows from
