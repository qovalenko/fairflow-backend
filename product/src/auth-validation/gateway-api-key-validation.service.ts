...
export class GatewayApiKeyValidationService implements OnModuleInit {
   ...
   */
  private readonly staleGraceMs = parseInt(process.env.GATEWAY_KEY_STALE_GRACE_MS ?? '600000', 10);
  /** Upper bound on distinct cached keys before LRU eviction kicks in. */
  private readonly maxEntries = parseInt(process.env.GATEWAY_KEY_CACHE_MAX ?? '1000', 10);
