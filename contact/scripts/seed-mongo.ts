/**
 * Seed contacts and companies for dev. projectId from services/.fairflow-dev.env (DEV_PROJECT_ID).
 * Run after: npm run db:provision && npm run db:seed:mongo
 * Or: MONGODB_URI=... DEV_PROJECT_ID=... npx ts-node scripts/seed-mongo.ts
 */
